...
impl W {
    #[doc = "Bit 0 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU0(&mut self) -> PU0_W<'_, PUCRE_SPEC> {
        PU0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU1(&mut self) -> PU1_W<'_, PUCRE_SPEC> {
        PU1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU2(&mut self) -> PU2_W<'_, PUCRE_SPEC> {
        PU2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU3(&mut self) -> PU3_W<'_, PUCRE_SPEC> {
        PU3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU4(&mut self) -> PU4_W<'_, PUCRE_SPEC> {
        PU4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU5(&mut self) -> PU5_W<'_, PUCRE_SPEC> {
        PU5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU6(&mut self) -> PU6_W<'_, PUCRE_SPEC> {
        PU6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU7(&mut self) -> PU7_W<'_, PUCRE_SPEC> {
        PU7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU8(&mut self) -> PU8_W<'_, PUCRE_SPEC> {
        PU8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU9(&mut self) -> PU9_W<'_, PUCRE_SPEC> {
        PU9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU10(&mut self) -> PU10_W<'_, PUCRE_SPEC> {
        PU10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU11(&mut self) -> PU11_W<'_, PUCRE_SPEC> {
        PU11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU12(&mut self) -> PU12_W<'_, PUCRE_SPEC> {
        PU12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU13(&mut self) -> PU13_W<'_, PUCRE_SPEC> {
        PU13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU14(&mut self) -> PU14_W<'_, PUCRE_SPEC> {
        PU14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Port E pull-up bit y (y=0..15)"]
    #[inline(always)]
    pub fn PU15(&mut self) -> PU15_W<'_, PUCRE_SPEC> {
        PU15_W::new(self, 15)
    }
}
