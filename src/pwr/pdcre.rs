...
impl W {
    #[doc = "Bit 0 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD0(&mut self) -> PD0_W<'_, PDCRE_SPEC> {
        PD0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD1(&mut self) -> PD1_W<'_, PDCRE_SPEC> {
        PD1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD2(&mut self) -> PD2_W<'_, PDCRE_SPEC> {
        PD2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD3(&mut self) -> PD3_W<'_, PDCRE_SPEC> {
        PD3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD4(&mut self) -> PD4_W<'_, PDCRE_SPEC> {
        PD4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD5(&mut self) -> PD5_W<'_, PDCRE_SPEC> {
        PD5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD6(&mut self) -> PD6_W<'_, PDCRE_SPEC> {
        PD6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD7(&mut self) -> PD7_W<'_, PDCRE_SPEC> {
        PD7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD8(&mut self) -> PD8_W<'_, PDCRE_SPEC> {
        PD8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD9(&mut self) -> PD9_W<'_, PDCRE_SPEC> {
        PD9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD10(&mut self) -> PD10_W<'_, PDCRE_SPEC> {
        PD10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD11(&mut self) -> PD11_W<'_, PDCRE_SPEC> {
        PD11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD12(&mut self) -> PD12_W<'_, PDCRE_SPEC> {
        PD12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD13(&mut self) -> PD13_W<'_, PDCRE_SPEC> {
        PD13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD14(&mut self) -> PD14_W<'_, PDCRE_SPEC> {
        PD14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Port E pull-down bit y (y=0..15)"]
    #[inline(always)]
    pub fn PD15(&mut self) -> PD15_W<'_, PDCRE_SPEC> {
        PD15_W::new(self, 15)
    }
}
