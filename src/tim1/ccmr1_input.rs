...
impl W {
    ...
    #[doc = "Bit 2 - Output Compare 1 fast enable"]
    #[inline(always)]
    pub fn OC1FE(&mut self) -> OC1FE_W<'_, CCMR1_INPUT_SPEC> {
        OC1FE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Output Compare 1 preload enable"]
    #[inline(always)]
    pub fn OC1PE(&mut self) -> OC1PE_W<'_, CCMR1_INPUT_SPEC> {
        OC1PE_W::new(self, 3)
    }
    #[doc = "Bits 4:6 - Output Compare 1 mode"]
    #[inline(always)]
    pub fn OC1M(&mut self) -> OC1M_W<'_, CCMR1_INPUT_SPEC> {
        OC1M_W::new(self, 4)
    }
    #[doc = "Bit 7 - Output Compare 1 clear enable"]
    #[inline(always)]
    pub fn OC1CE(&mut self) -> OC1CE_W<'_, CCMR1_INPUT_SPEC> {
        OC1CE_W::new(self, 7)
    }
    #[doc = "Bits 8:9 - Capture/Compare 2 selection"]
    #[inline(always)]
    ...
    #[doc = "Bit 10 - Output Compare 2 fast enable"]
    #[inline(always)]
    pub fn OC2FE(&mut self) -> OC2FE_W<'_, CCMR1_INPUT_SPEC> {
        OC2FE_W::new(self, 10)
    }
    #[doc = "Bit 11 - Output Compare 2 preload enable"]
    #[inline(always)]
    pub fn OC2PE(&mut self) -> OC2PE_W<'_, CCMR1_INPUT_SPEC> {
        OC2PE_W::new(self, 11)
    }
    #[doc = "Bits 12:14 - Output Compare 2 mode"]
    #[inline(always)]
    pub fn OC2M(&mut self) -> OC2M_W<'_, CCMR1_INPUT_SPEC> {
        OC2M_W::new(self, 12)
    }
    #[doc = "Bit 15 - Output Compare 2 clear enable"]
    #[inline(always)]
    pub fn OC2CE(&mut self) -> OC2CE_W<'_, CCMR1_INPUT_SPEC> {
        OC2CE_W::new(self, 15)
    }
}
