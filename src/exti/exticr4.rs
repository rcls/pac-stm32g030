...
impl W {
    #[doc = "Bits 0:7 - GPIO port selection"]
    #[inline(always)]
    pub fn EXTI0_7(&mut self) -> EXTI0_7_W<'_, EXTICR4_SPEC> {
        EXTI0_7_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - GPIO port selection"]
    #[inline(always)]
    pub fn EXTI8_15(&mut self) -> EXTI8_15_W<'_, EXTICR4_SPEC> {
        EXTI8_15_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - GPIO port selection"]
    #[inline(always)]
    pub fn EXTI16_23(&mut self) -> EXTI16_23_W<'_, EXTICR4_SPEC> {
        EXTI16_23_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - GPIO port selection"]
    #[inline(always)]
    pub fn EXTI24_31(&mut self) -> EXTI24_31_W<'_, EXTICR4_SPEC> {
