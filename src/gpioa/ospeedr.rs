...
impl W {
    #[doc = "Bits 0:1 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR0(&mut self) -> OSPEEDR0_W<'_, OSPEEDR_SPEC> {
        OSPEEDR0_W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR1(&mut self) -> OSPEEDR1_W<'_, OSPEEDR_SPEC> {
        OSPEEDR1_W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR2(&mut self) -> OSPEEDR2_W<'_, OSPEEDR_SPEC> {
        OSPEEDR2_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR3(&mut self) -> OSPEEDR3_W<'_, OSPEEDR_SPEC> {
        OSPEEDR3_W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR4(&mut self) -> OSPEEDR4_W<'_, OSPEEDR_SPEC> {
        OSPEEDR4_W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR5(&mut self) -> OSPEEDR5_W<'_, OSPEEDR_SPEC> {
        OSPEEDR5_W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR6(&mut self) -> OSPEEDR6_W<'_, OSPEEDR_SPEC> {
        OSPEEDR6_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR7(&mut self) -> OSPEEDR7_W<'_, OSPEEDR_SPEC> {
        OSPEEDR7_W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR8(&mut self) -> OSPEEDR8_W<'_, OSPEEDR_SPEC> {
        OSPEEDR8_W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR9(&mut self) -> OSPEEDR9_W<'_, OSPEEDR_SPEC> {
        OSPEEDR9_W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR10(&mut self) -> OSPEEDR10_W<'_, OSPEEDR_SPEC> {
        OSPEEDR10_W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR11(&mut self) -> OSPEEDR11_W<'_, OSPEEDR_SPEC> {
        OSPEEDR11_W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR12(&mut self) -> OSPEEDR12_W<'_, OSPEEDR_SPEC> {
        OSPEEDR12_W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR13(&mut self) -> OSPEEDR13_W<'_, OSPEEDR_SPEC> {
        OSPEEDR13_W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR14(&mut self) -> OSPEEDR14_W<'_, OSPEEDR_SPEC> {
        OSPEEDR14_W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn OSPEEDR15(&mut self) -> OSPEEDR15_W<'_, OSPEEDR_SPEC> {
